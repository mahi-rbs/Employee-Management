                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('employee-management.update', ['id' => $employee->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('name_bangla') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name_bangla" type="text" class="form-control" name="name_bangla" value="{{ $employee->name_bangla }}" required>
                        ...
                        <div class="form-group{{ $errors->has('father') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="father" type="text" class="form-control" name="father" value="{{ $employee->father }}" required>
                        ...
                        <div class="form-group{{ $errors->has('mother') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mother" type="text" class="form-control" name="mother" value="{{ $employee->mother }}" required>
                        ...
                        <div class="form-group{{ $errors->has('pre_address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="pre_address" type="text" class="form-control" name="pre_address" required>{{ $employee->pre_address }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('per_address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="per_address" type="text" class="form-control" name="per_address" required>{{ $employee->per_address }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="text" class="form-control" name="mobile" value="{{ $employee->mobile }}" required>
                        ...
                        <div class="form-group{{ $errors->has('nid') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nid" type="text" class="form-control" name="nid" value="{{ $employee->nid }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="work_place">
                                    @foreach ($wps as $wp)
                                    <option {{$employee->work_place == $wp->id ? 'selected' : ''}} value="{{$wp->id}}">{{$wp->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="past_work_place">
                                    @foreach ($wps as $wp)
                                    <option {{$employee->past_work_place == $wp->id ? 'selected' : ''}} value="{{$wp->id}}">{{$wp->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group date">
                                    ...
                                    <input type="text" value="{{ $employee->date_resigne }}" name="date_resigne" class="form-control pull-right" id="resigneDate" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('computer_skill') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="computer_skill" type="text" class="form-control" name="computer_skill" value="{{ old('computer_skill') }}" required>{{$employee->computer_skill}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group date">
                                    ...
                                    <input type="text" value="{{ $employee->dob }}" name="dob" class="form-control pull-right" id="birthDate" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <img src="{{asset('/../avatars/'.$employee->picture)}}" width="50px" height="50px"/>
